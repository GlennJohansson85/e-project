...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        """
        self.order_total = self.lineitems.aggregate(Sum('lineitem_total'))['lineitem_total__sum']                                           # a method to update the total which we can do using the aggregate function.
